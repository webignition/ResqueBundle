<?php
namespace Glit\ResqueBundle\Twig;
...
class ResqueExtension extends \Twig_Extension {
    ...
    public function getFilters() {
        return array(
            'resque_relativeDate'  => new \Twig_Filter_Method($this, 'relativeDate'),
            'resque_localeDate'    => new \Twig_Filter_Method($this, 'localeDate'),

            'resque_trim'          => new \Twig_Filter_Method($this, 'trim'),

            'resque_debug'         => new \Twig_Filter_Method($this, 'debug'),
            'resque_type'          => new \Twig_Filter_Method($this, 'type'),
        );
    }
